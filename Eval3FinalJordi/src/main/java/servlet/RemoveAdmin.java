...
public class RemoveAdmin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
		/* Web title and content */
	      String title = "Eliminar administrador";
	      String content = "Elimina un administrador de la base de datos";
		...
		// servlet action
	      ...
	      toDelete.setId(adminId);
	      
	     
	      boolean checkOK = true;	      
	      try{
	    	  dbhelper.removeAdmin(toDelete);
	      }catch (RuntimeException e ){	    	  
	    	  checkOK = false;
	      }
	      ...
	      if(checkOK==true){
	    	  message= "&nbsp &nbsp" + "El administrador con ID " + adminId + " se ha borrado correctamente.";
	      }else{
	    	  message= "&nbsp &nbsp" + "El administrador introducido no existe en la base de datos.";
	      }
