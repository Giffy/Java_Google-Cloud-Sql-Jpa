...
public class UpdateGallery extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
		/* Web title and content */
	      String title = "Actualizar una galeria";
	      String content = "Actualiza una galeria de la base de datos";
		...
		// servlet action
	      ...
	      galleryToUpdate.setName(name);
	      galleryToUpdate.setDescription(description);
	      
	      boolean checkOK = true;
	      try{
	    	  dbhelper.update(galleryToUpdate);
	 	  }catch (RuntimeException e ){	    	  
	 	   	  checkOK = false;
	 	  }
	      ...
	      if(checkOK==true){
	    	  message= "&nbsp &nbsp " + "La galeria con ID: " + galleryId + ",se ha actualizado correctamente.";
	      }else{
